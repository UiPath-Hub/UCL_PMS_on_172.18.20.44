export default {
	...
	DefaultEntity:DefaultInventory,
	PropName:INVENTORY_NAME.widgetName,
	//this stored procedure need to return [{"COUNT":number}]
	countCheck:async()=>{
		await SELECT_DUPLICATE_NAME.run();
		return SELECT_DUPLICATE_NAME.data;
