export default {
	...
	PROVINCE_PROP_NAME:(COMPANY_LANGUAGE_TYPE.selectedOptionValue?COMPANY_LANGUAGE_TYPE.selectedOptionValue:"TH") == "TH"? "BILLING_COMPANY_PROVINCE_TH":"BILLING_COMPANY_PROVINCE_EN",
	DISTRICT_PROP_NAME:(COMPANY_LANGUAGE_TYPE.selectedOptionValue?COMPANY_LANGUAGE_TYPE.selectedOptionValue:"TH") == "TH"?"BILLING_COMPANY_DISTRICT_TH":"BILLING_COMPANY_DISTRICT_EN",
	SUB_DISTRICT_PROP_NAME:(COMPANY_LANGUAGE_TYPE.selectedOptionValue?COMPANY_LANGUAGE_TYPE.selectedOptionValue:"TH") == "TH"?"BILLING_COMPANY_SUB_DISTRICT_TH":"BILLING_COMPANY_SUB_DISTRICT_EN",
	//store
	PROVINCE:"PROVINCE",
	DISTRICT_STORE_NAME:"BILLING_DISTRICT",
	SUB_DISTRICT_STORE_NAME:"BILLING_SUBDISTRICT",
	//reconstruct the widget to handle a function calling of widget. 
	PROVINCE_WIDGET: {...BILLING_PROVINCE_TH,setDisabled:async(value)=>{await BILLING_PROVINCE_TH.setDisabled(value)}},
	DISTRICT_WIDGET:{...BILLING_DISTRICT_TH,setDisabled:async(value)=>{await BILLING_DISTRICT_TH.setDisabled(value)}},
	SUB_DISTRICT_WIDGET:{...BILLING_SUB_DISTRICT_TH,setDisabled:async(value)=>{await BILLING_SUB_DISTRICT_TH.setDisabled(value)}},
	POSTAL_CODE_WIDGET:BILLING_POSTAL_CODE,
